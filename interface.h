...
int load_index (char *filename_dat, char *filename_lcp, char *filename_sa, void **index, char Verbose, FILE **file_name_const, char *size_text);
...
int locate (void *index, uchar *pattern, ulong length, ulong **occ, ulong *numocc, FILE *file);
